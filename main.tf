...
resource "aws_route" "public_routes" {
  count = var.create_vpc  && length(var.public_subnets_routes) > 0 ? local.nat_gateway_count * length(var.public_subnets_routes) : 0
...
resource "aws_route" "private_routes" {
  count = var.create_vpc  && length(var.private_subnets_routes) > 0 ? local.nat_gateway_count * length(var.private_subnets_routes) : 0
...
resource "aws_route" "database_routes" {
  count = var.create_vpc  && length(var.database_subnets_routes) > 0 ? local.nat_gateway_count * length(var.database_subnets_routes) : 0
...
resource "aws_route" "redshift_routes" {
  count = var.create_vpc  && length(var.redshift_subnets_routes) > 0  ? local.nat_gateway_count * length(var.redshift_subnets_routes) : 0
...
resource "aws_route" "elasticache_routes" {
  count = var.create_vpc  && length(var.elasticache_subnets_routes) > 0  ? local.nat_gateway_count * length(var.elasticache_subnets_routes) : 0
...
resource "aws_route" "intra_routes" {
  count = var.create_vpc  && length(var.intra_subnets_routes) > 0  ? local.nat_gateway_count * length(var.intra_subnets_routes) : 0
