...
resource "aws_route" "public_routes" {
  ...
  route_table_id         = element(aws_route_table.public.*.id, floor(count.index / length(var.public_subnets_routes) + count.index))
...
resource "aws_route" "database_routes" {
  ...
  route_table_id         = var.create_database_subnet_route_table ? element(aws_route_table.database[0].id, floor(count.index / length(var.database_subnets_routes) + count.index)) : element(aws_route_table.private.*.id, floor(count.index / length(var.database_subnets_routes) + count.index))
...
resource "aws_route" "redshift_routes" {
  ...
  route_table_id         = var.create_redshift_subnet_route_table ? element(aws_route_table.redshift[0].id, floor(count.index / length(var.redshift_subnets_routes) + count.index)) : element(aws_route_table.private.*.id, floor(count.index / length(var.redshift_subnets_routes) + count.index))
...
resource "aws_route" "elasticache_routes" {
  ...
  route_table_id         = var.create_elasticache_subnet_route_table ? element(aws_route_table.elasticache[0].id, floor(count.index / length(var.elasticache_subnets_routes) + count.index)) : element(aws_route_table.elasticache.*.id, floor(count.index / length(var.elasticache_subnets_routes) + count.index))
